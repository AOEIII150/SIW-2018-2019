        ...
        if(fotografoService.MostraTutti().isEmpty()){
            ...
            if(albumService.MostraTutti().isEmpty()) {
                ...
                if(fotoService.MostraTutti().isEmpty()) {
                    ...
                    Foto ft1 = new Foto("Auto classica", "https://hdrihaven.com/files/gallery/L/habib%20roohzendeh_konzerthaus_7AWc.jpg", a1, f1);
                    Foto ft2 = new Foto("Auto arancio e gialla", "https://hdrihaven.com/files/gallery/L/pink_road.jpg", a1, f1);
                    Foto ft3 = new Foto("Auto rosa", "https://bit.ly/2FidjaH", a1, f1);
