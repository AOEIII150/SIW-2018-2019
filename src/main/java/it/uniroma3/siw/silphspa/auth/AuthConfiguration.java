...
public class AuthConfiguration extends WebSecurityConfigurerAdapter{
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        .antMatchers("/addFoto").hasAnyAuthority("ADMIN")
        .antMatchers("/addAlbum").hasAnyAuthority("ADMIN")
        .antMatchers("/cercaFotografo").hasAnyAuthority("ADMIN")
        .antMatchers("/cercaFoto").hasAnyAuthority("ADMIN")
        .antMatchers("/cercaAlbum").hasAnyAuthority("ADMIN")
